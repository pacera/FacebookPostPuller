 ...
 * @author RJ
 */
public class PostModel extends Observable implements Runnable {
    ...
    public PostModel(String threadName, FacebookClient facebookClient, Connection<User> myFriends, int startIndex, int endIndex, boolean[] check) {
        ...
        PostModel.posts = new HashMap<>();
        PostModel.metadata = new HashMap<>();
